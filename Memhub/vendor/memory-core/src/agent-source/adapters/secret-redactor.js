const REDACTION_RULES = [
    ...
    },
    {
        ...
        replace: (_match, prefix) => `${prefix}[REDACTED:authorization_bearer]`
    },
    {
...
function redactBase64Runs(input, minLength) {
    let output = "";
    let cursor = 0;
    let index = 0;
