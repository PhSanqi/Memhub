...
const SOURCE_EXTENSION_SET = new Set(PROJECT_SOURCE_EXTENSIONS);
...
export function classifyProjectInventory(entries) {
    ...
    for (const file of files) {
        ...
        if (depth <= 2 && isBuildMarker(file.relativePath))
            hasMarker = true;
    }
    return {
...
function isBuildMarker(relativePath) {
