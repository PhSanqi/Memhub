import { WorkspaceIdentityFieldsSchema, isLocalWorkspaceUri, sha256Hex } from "../../contracts/index.js";
/**
 ...
 */
export function resolveWorkspaceIdentity(effectiveUserId, input) {
    const userId = effectiveUserId.trim();
    if (!userId)
        throw new TypeError("effectiveUserId must be non-empty");
