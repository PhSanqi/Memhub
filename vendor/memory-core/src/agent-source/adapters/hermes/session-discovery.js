...
export async function discoverHermesSessions(options) {
...
async function listJsonlFiles(root, order, maxSessions) {
    let entries;
    try {
...
async function readFirstWorkspaceMetadata(filePath) {
    try {
