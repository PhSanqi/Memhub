...
export function optionBoolean(options, name) {
    const value = options[name];
    if (value === undefined)
        return undefined;
    if (value === true)
...
export async function readBodyObject(options) {
...
export function parseJsonOrCliValue(raw) {
...
async function readTextSource(path) {
