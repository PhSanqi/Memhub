...
const targets = [
  { id: "linux-complete", os: "linux", arch: "x64", format: "tar.gz", nodeArchive: `node-v${NODE_VERSION}-linux-x64.tar.xz` },
  { id: "windows-complete", os: "windows", arch: "x64", format: "zip", nodeArchive: `node-v${NODE_VERSION}-win-x64.zip` }
